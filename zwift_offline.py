...
def v1_variant():
    ...
    nru = variants.variants.add()
    nru.name = 'game_1_16_new_route_ui'
    nru.value = 1
    pdg = variants.variants.add()
    pdg.name = 'pack_dynamics_30_global'
    pdm = variants.variants.add()
    pdm.name = 'pack_dynamics_30_makuri'
    pdl = variants.variants.add()
    pdl.name = 'pack_dynamics_30_london'
    pdw = variants.variants.add()
    pdw.name = 'pack_dynamics_30_watopia'
    pde = variants.variants.add()
    pde.name = 'pack_dynamics_30_exclude_events'
    scn = variants.variants.add()
    scn.name = 'game_1_17_server_connection_notifications'
    rs = variants.variants.add()
    rs.name = 'zc_ios_aug_2021_release_sync'
